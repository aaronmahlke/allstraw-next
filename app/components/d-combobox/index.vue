...
<template>
  ...
  >
    <ComboboxAnchor as-child>
      <ComboboxTrigger
        class="bg-surface-weak border-neutral text-neutral text-copy focus:bg-neutral hover:border-neutral-strong/15 disabled:bg-neutral-strong flex h-9 w-full min-w-40 items-center justify-between gap-1 rounded-lg border px-2.5 py-2 leading-none transition-all outline-none focus:border-neutral-300 focus:ring-2 focus:ring-neutral-200 disabled:cursor-not-allowed disabled:opacity-50"
      >
        <span class="flex">
          <slot
            name="trigger"
